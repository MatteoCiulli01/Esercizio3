			...
			<div class="user_card">
					...
					<form method="post">
						...
						<div class="input-group mb-2">
                            ...
                            if(array_key_exists("button",$_POST))
                            {
								...
								{
									$stand = fgets($file);
									if(strcmp(($Mail.PHP_EOL),$stand) == 0)
									{
										$stand = fgets($file);
									}
									if(strcmp(md5($Password.PHP_EOL),$stand))
									{
										header("Location: /Esercizio3/EsitoLog.php");
									}
								}
								fclose($file);
                            }
		        ...
		        <div class="mt-4">
					<div class="d-flex justify-content-center links">
						Don't have an account? <a href="home.php" class="ml-2">Sign Up</a>
					</div>
				</div>
                </form>
			</div>
