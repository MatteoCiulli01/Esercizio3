    ...
    ?>
            ...
            <form method="post" >
                <p>Modulo di iscrizione</p>
                    ...
                    <label name= "country" id="Country">Nazionalita</label>  
                            ...
                            <option value="Cook Islands">The Democratic Republic of The Cook Islands</option>
        ...
        <div id="Risultato" <?php if ($_SESSION["ShowRisultato"]==true){?>style="display:none"<?php } ?>>
            <form method="post">
                ...
                <div id="Patente">
                    <label>Patente:     <?php echo $_SESSION["PatenteA"]; if($_SESSION["PatenteA"] == null && $_SESSION["PatenteB"] == null){echo "Nessuna patente posseduta";}; echo $_SESSION["PatenteB"]; ?> </label>
                </div>
                <div id="eMail">
